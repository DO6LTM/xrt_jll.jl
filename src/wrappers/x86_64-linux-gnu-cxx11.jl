...
function __init__()
    JLLWrappers.@generate_init_header(boost_jll, ocl_icd_jll, rapidjson_jll, LibCURL_jll, libdrm_jll, Libuuid_jll, LibYAML_jll, Ncurses_jll, OpenSSL_jll, protobuf_c_jll, systemd_jll, systemtap_jll)
